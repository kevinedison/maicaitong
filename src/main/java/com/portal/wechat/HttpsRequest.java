...
public class HttpsRequest implements IServiceRequest
{
        ...
        KeyManagementException
    {
        ...
        SSLContext sslcontext =
            SSLContexts.custom().loadKeyMaterial(keyStore, Configure.getCertPassword().toCharArray()).build();
    ...
    public String sendPostJson(String url, Object obj)
        throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException,
        KeyManagementException
    {
        ...
        // 生成JSONMapper对象转换JSON
        JsonMapper mapper = new JsonMapper();
        
        // 将要提交给API的数据对象转换成XML格式数据Post给API
        String postDataJSON = mapper.toJson(obj);
